		 ...
		 else
		 {
		   ...
		   print "<tr bgcolor='#FFFBD6'>
	        ...
	        while($x=mysqli_fetch_array($execute))
		       {
			     $q1="select cat_name from addcat where cat_id=$x[1]";
				 $r1=mysqli_query($conn,$q1); 
				 $a1=mysqli_fetch_array($r1);
				 $q2="select subcat_name from addsubcat where subcat_id=$x[2]";
			     ...
			     if($c==0)
				  {
		            print "<tr bgcolor='#EED39D'>
				      ...
				      <td>$x[4]</td>
				      <td>$x[5]</td>
				      <td><img width=100 height=100 src='images/$x[6]'></td>
				      <td><a href='updateprod.php?id=$x[0]'><img src='pics/edit3.png' height=20 width=20></a></td>
				       <td><a href='deleteprod.php?id=$x[0]'><img src='pics/Delete.png' height=15 width=15></a></td>
