			     ...
			     if($c==0)
				  {
		            print "<tr bgcolor='#EED39D'>
					  ...
					  <td>$x[1]</td>
				      <td><img width=100 height=100 src='images/$x[3]'></td>
				      <td><a href='updatesubcat.php?id=$x[0]'><img src='pics/edit3.png' height=20 width=20></a></td>
				       <td><a href='deletesubcat.php?id=$x[0]'><img src='pics/Delete.png' height=15 width=15></a></td>
