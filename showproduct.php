...
$conn=mysqli_connect(host,uname,pass,db) or die(mysqli_connect_error());
	   ...
	   $q="select * from addproduct where subcat_id=$scatid"; 
	   ...
	   if($count==0)
		 ...
		 {
		    print"<table align=center width=900 cellpadding=3 cellspacing=0>";
			$mc=0;
			print "<tr><td colspan='3'><h2>Choose Product</h2></td></tr><tr align='center'>";
	        ...
	        while($x=mysqli_fetch_array($execute))
			 ...
			 print 
					"<td>
					 	<a href='showdetail.php?pid=$x[0]'><img width=175 height=170 src='images/$x[6]'></a>
						 <br/>
						<a href='showdetail.php?pid=$x[0]'>$x[3]</a>
					 </td>";
					 $mc++;
		        }
			print"</table>";
