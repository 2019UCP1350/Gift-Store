<?php
	...
	if(!isset($_SESSION["ad"]))
	   ...
	   $id=$_GET["id"];
	   $qu1="select * from addcat where Cat_ID=$id";
	   ...
	   if(isset($_POST["u1"]))
	  {
		 ...
		 $query="update addcat set Cat_name='$cat' ,Cat_pic='$ppic' where Cat_ID=$id";
		            ...
		            <tr>
		              <td><table width="100%">
		                ...
		                <tr>
		                  ...
		                  <td><label>
		                    <input type="text" name="ccat" id="ccat" value="<?php print $aa[1];?>" />
		                    </label></td>
	                    </tr>
		                <tr>
		                  <td>&nbsp;</td>
		                ...
		                <tr>
		                  ...
		                  <td><?php print"<img src='images/$aa[2]' width=100 height=100>"; ?>
		                    <label>
