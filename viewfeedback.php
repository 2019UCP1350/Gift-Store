		...
		<div class="container">
		  <div class="col-md-8 products-right">
		    <table width="100%" cellspacing="20">
		      <tr>
		        <td align="center"><h3>View Feedback</h3></td>
	          </tr>
		      <tr>
		        <td>&nbsp;</td>
	          </tr>
						  ...
						  if($c==0)
						    {
					          print"<tr bgcolor='#EED39D'>
						          ...
						          <td>$x[7]</td>
						          <td>$x[8]</td>
								  <td><a href='deletefeed.php?id=$x[0]'><img src='pics/Delete.png' height=15 width=15></a></td>
	 				            </tr>";
						       $c=1;
							 }
						else
							   {
							     print"<tr bgcolor='#DFC098'>
				                  <td>$x[1]</td>
							      <td>$x[2]</td>
						          <td>$x[3]</td>
					              <td>$x[4]</td>
